    ...
    public class Request : IDisposable
    {
        ...
        private void RewriteMethod()
        {
            ...
            var overrides =
                ...
                {
                    Tuple.Create("_method form input element", ((string)this.Form["_method"])?.ToUpperInvariant()),
                    Tuple.Create("X-HTTP-Method-Override form input element", ((string)this.Form["X-HTTP-Method-Override"])?.ToUpperInvariant()),
                    Tuple.Create("X-HTTP-Method-Override header", (this.Headers["X-HTTP-Method-Override"].FirstOrDefault())?.ToUpperInvariant())
                };
